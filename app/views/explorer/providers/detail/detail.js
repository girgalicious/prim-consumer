...
import { ListItem, Button, Avatar, Icon, withTheme, Divider, Rating } from 'react-native-elements';
...
const provider = navigation.getParam('provider');
  return (
    <View style={{flex: 1}}>
      <View style={{flex: 2}}>
        <ImageBackground source={bessie} style={{height: "100%", width: "100%"}}>
          ...
          <View style={{top: 30}}>
            <Text style={{marginLeft: 20, fontSize: 20, fontWeight: 'bold', color: 'white'}}>Bessie Cooper</Text>
          </View>
          <View style={{marginLeft: 20, top: 35, flex: 1, flexDirection: 'row'}}>
            <Icon
              name='cut'
              color='white'
              type='font-awesome'
              size={20}
              onPress={() => console.log('hello')} />
              <Text style={{marginLeft: 20, fontSize: 15, color: 'white'}}>Hair Dresser</Text>
          </View>
      ...
      <View style={{flex: 3}}>
        <View style={{alignItems: "center"}}>
          <Button title="SCHEDULE AN APPOINTMENT" titleStyle={{fontSize: 15, fontWeight: 'bold'}} style={styles.button} />
        </View>
        <View style={{alignItems: "center"}}>
        ...
        <View style={{marginLeft: 10, marginTop: 10}}>
          {
            list.map((item, i) => (
              <ListItem
                ...
                subtitle={item.price}
                subtitleStyle={{color: 'grey', top: 10, fontSize: 12}}
...
export default connect(mapStateToProps, { })(withTheme(ProviderDetail));
